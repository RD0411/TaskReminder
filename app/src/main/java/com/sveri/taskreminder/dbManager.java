package com.sveri.taskreminder;
...
public class dbManager extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1)
    {
        ...
        String query = "DROP TABLE IF EXISTS tbl_reminder"; //query to check table with the same name or not
    ...
    public String addreminder(String title, String date, String time)
    {
        ...
        float result = database.insert("tbl_reminder", null, contentValues);    //returns -1 if data dosen't successfully inserts into database
